...
| **Hot sale** (fixed section) | `home/hot-sale.response.json` | Offline shape. Live: `getHotSaleProductsSSG`; −% chỉ từ catalog thật (`compare_at` / `discount_percent`, D-PRC-03). Không FE synth %. |
