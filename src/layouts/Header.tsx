      ...
      <div className="py-4">
        <Container>
          <div className="flex items-center justify-between gap-4">
            {/* Logo */}
            <Link href={createLink('/')} className="flex-shrink-0">
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-primary-700">NHÀ THUỐC</span>
                <span className="text-xl font-semibold text-primary-600">OUPHARMACY</span>
              </div>
            </Link>
            ...
            <form action={createLink('/search')} className="flex-1 max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border-2 border-primary-200 px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                />
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  <button type="button" className="text-gray-400 hover:text-primary-600">
                  ...
                  <button type="submit" className="text-gray-400 hover:text-primary-600">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              <Link 
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary-700 whitespace-nowrap"
              >
                {t('login')}
              </Link>
              <Link 
                href={createLink('/cart')} 
                className="relative px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary-700 whitespace-nowrap"
              >
                {t('cart')}
