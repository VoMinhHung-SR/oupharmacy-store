  ...
  return (
    <div className="flex-1 min-w-[220px]">
      {displayItems.map((level1) => {
        ...
        return (
          <Link
            ...
            className={`block px-4 py-2.5 text-sm font-medium transition-colors rounded-lg whitespace-nowrap overflow-hidden text-ellipsis mb-1 last:mb-0 ${
              isActive && hasLevel2
      ...
      {hasMore && (
        <Link
          href={categoryHref}
          className="block px-4 py-2.5 text-sm text-primary-600 hover:bg-gray-100 hover:text-primary-700 transition-colors rounded-lg font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
