...
export function ProductDetailScheduledPromoBanner({
  ...
  return (
    <div
      className="flex items-start gap-1.5 rounded-xl border border-sky-200/90 bg-gradient-to-r from-sky-50 to-primary-50/40 px-2.5 py-2 sm:gap-2 sm:px-3 sm:py-2.5"
      role="note"
      aria-label={copy.fullMessage}
    >
      <PromoIcon size="sm" tone="brand" className="mt-0.5 shrink-0" />
