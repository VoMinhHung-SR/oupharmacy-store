    ...
    <div className="space-y-4 bg-white rounded-lg p-4" style={{ width: `${SIDEBAR.WIDTH}px` }}>
      ...
      {filters.map((filterGroup) => (
        <FilterGroupItem
          ...
          onToggleSection={() => toggleSection(filterGroup.id)}
          onToggleShowMore={() => toggleShowMore(filterGroup.id)}
          onSearchChange={(query) => setSearchQueries(prev => ({ ...prev, [filterGroup.id]: query }))}
