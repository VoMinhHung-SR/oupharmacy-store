...
| Quick cate | `HOME_QUICK_LINKS` | Live: mua thuốc / tư vấn / đơn / nhắc uống (`/tai-khoan/tu-thuoc?tab=doses`) / tủ thuốc; **Sắp có:** tra cứu. Hotline demo `STORE_SUPPORT` `1800 6868`. |
